...
def upload():
    ...
    if 'resume' in request.files:
        ...
        if not skills:
            print('work')
            return render_template('result.html', error='No skills found in the resume')
...
def generate_answers(questions):
    # Implement your logic to generate answers based on the questions
...
def separate_and_transcribe_videos(video_folder, output_excel):
    ...
    results = []
    VideoFileClip.DEFAULT_EXECUTABLE = "C:/Users/yamin/Downloads/skill based quiz partial/skill based quiz partial - Copy/ffmpeg"
